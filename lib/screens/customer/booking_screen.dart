...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Future<void> _submitBooking() async {
    ...
    try {
      ...
      if (result['_id'] != null || result['booking'] != null) {
        // Navigate to receipt screen with booking data
        if (mounted) {
        ...
        _showSnack(result['message'] ?? 'Booking failed. Please try again.');
      }
    } catch (e) {
      setState(() => _loading = false);
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Your reservation has been submitted. We will contact you to confirm.',
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: loading
              ...
              : Text(step < 3 ? 'Continue' : 'Confirm Booking',
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        // Oasis selector
        Text('Choose Oasis', style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        Row(
        ...
        // Session
        Text('Session Type', style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
        const SizedBox(height: 8),
        Row(
...
class _PackageStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        Text('Choose Package', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w700)),
                  ...
                  if (isSelected && pkg.addons.isNotEmpty) ...[
                    ...
                    ...pkg.addons.map((addon) {
                      ...
                      return CheckboxListTile(
                        ...
                        title: Text(addon, style: GoogleFonts.poppins(fontSize: 13)),
                        onChanged: (v) {
...
class _GuestInfoStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        Text('Guest Information', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 16),
        TextFormField(
          controller: nameCtrl,
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(labelText: 'Number of Guests *', prefixIcon: Icon(Icons.group_outlined)),
          validator: (v) {
            if (v?.isEmpty == true) return 'Required';
            if (int.tryParse(v!) == null || int.parse(v) < 1) return 'Enter a valid number';
            return null;
          },
        ),
      ],
...
class _ReviewStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        Text('Review & Payment', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w700)),
        const SizedBox(height: 16),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Total Price', style: GoogleFonts.poppins(fontWeight: FontWeight.w700, fontSize: 15)),
        ...
        // Downpayment
        Text('Downpayment Amount', style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
        const SizedBox(height: 4),
